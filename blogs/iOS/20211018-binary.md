...
<img :src="$withBase('/imgs/page.jpeg')" alt="mixureSecure" height="500px">
...
<img :src="$withBase('/imgs/linkmap.png')" alt="mixureSecure">
...
<img :src="$withBase('/imgs/order_file.png')" alt="mixureSecure">
