...
<img :src="$withBase('/imgs/float_img.png')" alt="mixureSecure">
...
<img :src="$withBase('/imgs/float_column.png')" alt="mixureSecure">
...
<img :src="$withBase('/imgs/float_noheight.png')" alt="mixureSecure">
...
<img :src="$withBase('/imgs/float_height.png')" alt="mixureSecure">
